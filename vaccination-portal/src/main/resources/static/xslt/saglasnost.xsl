    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <p class="indent-paragraph">(попунио пацијент)</p>
                <p class="indent-paragraph">
                    <b>Држављанство   </b>1) Република Србија | ЈМБГ
                ...
                <p class="indent-paragraph" style="margin-left: 21vw;">
                    ...
                    <xsl:if test="//s:Drzavljanstvo/s:Naziv_stranog_drzavljanstva">
                        <b>
                            <xsl:value-of select="concat(' ', //s:Drzavljanstvo/s:Naziv_stranog_drzavljanstva, ' ')"/>
                        </b>
                    </xsl:if>
                    | Број пасоша или ЕБС
                ...
                <p class="indent-paragraph">
                    <b>Изјављујем да: САГЛАСАН САМ </b>
                ...
                <p class="indent-paragraph" style="border-bottom: 3px dashed black; margin-right: 10vw;">
                    <b>Лекар ми је објаснио предности и ризике од спровођења активне/пасивне имунизације наведеним
                        имунолошким леком.
                    </b>
                </p>
                <xsl:if test="//s:Evidencija_o_vakcinaciji">
                    <h1 style="font-weight: normal; text-align: center;">ЕВИДЕНЦИЈА О ВАКЦИНАЦИЈИ ПРОТИВ COVID-19</h1>
                    <p style="text-align: center;">(попуњава здравствени радник)</p>
                    <p class="indent-paragraph">
                    ...
                    <table style="width: 80vw; margin: 20px 10vw 20px 10vw;">
                        ...
                        <tr>
                            <td colspan="7">Привремене контрадикције (датум утврђивања и дијагноза):
                        ...
                        <tr>
                            <td colspan="7">Одлука комисије за трајне контрадикције (ако постоји, уписати Да)
